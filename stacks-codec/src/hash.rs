...
crate::impl_array_newtype!(Keccak256Hash, u8, 32);
crate::impl_array_hexstring_fmt!(Keccak256Hash);
crate::impl_byte_array_newtype!(Keccak256Hash, u8, 32);
...
crate::impl_array_newtype!(Sha256Sum, u8, 32);
crate::impl_array_hexstring_fmt!(Sha256Sum);
crate::impl_byte_array_newtype!(Sha256Sum, u8, 32);
...
crate::impl_array_newtype!(Sha512Sum, u8, 64);
crate::impl_array_hexstring_fmt!(Sha512Sum);
crate::impl_byte_array_newtype!(Sha512Sum, u8, 64);
...
crate::impl_array_newtype!(DoubleSha256, u8, 32);
crate::impl_array_hexstring_fmt!(DoubleSha256);
crate::impl_byte_array_newtype!(DoubleSha256, u8, 32);
...
#[cfg(test)]
mod test {
    use super::{DoubleSha256, MerkleHashFunc, MerkleTree};
    use crate::hex::{bin_bytes, hex_bytes, to_bin};
